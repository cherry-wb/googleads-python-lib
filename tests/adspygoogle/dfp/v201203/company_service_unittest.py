...
from examples.adspygoogle.dfp.v201203.company_service import create_companies
from examples.adspygoogle.dfp.v201203.company_service import get_advertisers
from examples.adspygoogle.dfp.v201203.company_service import get_all_companies
from examples.adspygoogle.dfp.v201203.company_service import update_companies
from tests.adspygoogle.dfp import client
from tests.adspygoogle.dfp import SERVER_V201203
from tests.adspygoogle.dfp import TEST_VERSION_V201203
from tests.adspygoogle.dfp import util
from tests.adspygoogle.dfp import VERSION_V201203
  ...
  def setUp(self):
    ...
    if not self.__class__.loaded:
      self.__class__.test_advertiser_id = util.CreateTestAdvertiser(
          client, SERVER_V201203, VERSION_V201203)

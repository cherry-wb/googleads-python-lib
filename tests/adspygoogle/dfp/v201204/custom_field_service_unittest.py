...
from examples.adspygoogle.dfp.v201204.custom_field_service import create_custom_field_options
from examples.adspygoogle.dfp.v201204.custom_field_service import create_custom_fields
from examples.adspygoogle.dfp.v201204.custom_field_service import deactivate_all_line_item_custom_fields
from examples.adspygoogle.dfp.v201204.custom_field_service import get_all_custom_fields
from examples.adspygoogle.dfp.v201204.custom_field_service import get_all_line_item_custom_fields
from examples.adspygoogle.dfp.v201204.custom_field_service import set_line_item_custom_field_value
from examples.adspygoogle.dfp.v201204.custom_field_service import update_custom_fields
...
class CustomFieldServiceTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    if not self.__class__.loaded:
      ...
      order_id = util.CreateTestOrder(
          client, SERVER_V201204, VERSION_V201204, advertiser_id, trafficker_id)
      ad_unit_id = util.CreateTestAdUnit(
          client, SERVER_V201204, VERSION_V201204)
      placement_id = util.CreateTestPlacement(
          client, SERVER_V201204, VERSION_V201204, [ad_unit_id])
      self.__class__.test_line_item_id = util.CreateTestLineItem(
          client, SERVER_V201204, VERSION_V201204, order_id, [placement_id])

      self.__class__.test_drop_down_custom_field_id = (
          util.CreateTestLineItemCustomField(
              client, SERVER_V201204, VERSION_V201204, 'DROP_DOWN'))
  ...
  def testSetLineItemCustomFieldValue(self):
    ...
    test_string_custom_field_id = util.CreateTestLineItemCustomField(
        client, SERVER_V201204, VERSION_V201204, 'STRING')
    ...
    drop_down_custom_field_option_id = util.CreateTestLineItemCustomFieldOption(
        client, SERVER_V201204, VERSION_V201204, test_drop_down_custom_field_id)

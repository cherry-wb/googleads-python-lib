...
class DfaWebServiceTestV1_18(unittest.TestCase):

  """Unittest suite for DfaWebService using v1_18."""
...
class TestThreadV1_18(threading.Thread):

  """Creates TestThread using v1_18.
  ...
  def run(self):
    ...
    search_criteria = {'pageSize': '10'}
    DfaWebServiceTestV1_18.res.append(client.GetAdvertiserService(
        DfaWebServiceTestV1_18.SERVER, DfaWebServiceTestV1_18.VERSION,

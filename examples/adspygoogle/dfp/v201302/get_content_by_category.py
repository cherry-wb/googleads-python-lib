...
content_service = client.GetService('ContentService', version='v201302')

network_service = client.GetService('NetworkService', version='v201302')

custom_targeting_service = client.GetService(
    'CustomTargetingService', version='v201302')

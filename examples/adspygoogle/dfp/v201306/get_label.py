...
"""This code example gets an label by its id. To determine which labels
...
label_service = client.GetService('LabelService', version='v201306')

# Set the id of the label to get.
label_id = 'INSERT_LABEL_ID_HERE'

# Get label.
label = label_service.GetLabel(label_id)[0]

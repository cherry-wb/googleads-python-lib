...
def main(client):
  ...
  company_service = client.GetService('CompanyService', version='v201204')
  ...
  companies = DfpUtils.GetAllEntitiesByStatementWithService(
      company_service, query=query, bind_vars=values)

...
def main(client, campaign_id):
  ...
  feed_item_service = client.GetFeedItemService(version='v201309')
  feed_mapping_service = client.GetFeedMappingService(version='v201309')
  campaign_feed_service = client.GetCampaignFeedService(version='v201309')

...
def main(client, campaign_ids):
  ...
  campaign_ad_extension_service = client.GetCampaignAdExtensionService(
      version='v201302')
  feed_service = client.GetFeedService(version='v201302')
  feed_item_service = client.GetFeedItemService(version='v201302')
  feed_mapping_service = client.GetFeedMappingService(version='v201302')
  campaign_feed_service = client.GetCampaignFeedService(version='v201302')
